...
const Dashboard = dynamic(
  () => import("@/components/dashboard/minimalist-dashboard"),
  {
    loading: () => (
...
export default async function DashboardPage() {
  ...
  try {
    ...
    const { data: profile } = await supabase
      .from("profiles")
      .select(
        "subscription_tier, subscription_status, lifetime_credits_granted, lifetime_credits_used, monthly_credits, monthly_credits_used, credits_reset_at, stripe_customer_id",
      )
      .eq("id", userId as any)
      .single();
        ...
        userProfile={
          userProfile
            ? {
                ...
                lifetime_credits_granted: userProfile.lifetime_credits_granted ?? undefined,
                lifetime_credits_used: userProfile.lifetime_credits_used ?? undefined,
                monthly_credits: userProfile.monthly_credits ?? undefined,
                monthly_credits_used: userProfile.monthly_credits_used ?? undefined,
                credits_reset_at: userProfile.credits_reset_at ?? undefined,
