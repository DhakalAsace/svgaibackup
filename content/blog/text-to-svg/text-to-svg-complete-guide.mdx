...
<div class="mt-10 p-6 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-100 shadow-md">
  <h3 class="text-xl font-bold mb-3 text-blue-800">Ready to Transform Your Ideas into Vector Graphics?</h3>
  <p class="mb-5 text-blue-700">Experience the power of AI-driven SVG creation with our intuitive text-to-SVG generator. No design skills required!</p>
  <div class="flex flex-col sm:flex-row gap-4 items-center">
    <a 
      href="https://svgai.org/" 
      class="px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-black rounded-lg hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 shadow-lg flex items-center justify-center gap-2 text-lg font-medium"
    >
